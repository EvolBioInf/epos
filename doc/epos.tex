...
#m = 1; maximum Log(Likelihood):   -1719.15 {2}
#m = 2; maximum Log(Likelihood):    -106.14 {2,11}
#m = 3; maximum Log(Likelihood):    -104.75 {2,4,11}
#Final Log(Likelihood):             -106.14
#d^2: 0.00262777
...
#m = 1; maximum Log(Likelihood):   -1719.15 {2}
#m = 2; maximum Log(Likelihood):    -106.14 {2,11}
#m = 3; maximum Log(Likelihood):     -99.51 {2,4,9}
#m = 4; maximum Log(Likelihood):     -97.14 {2,5,12,13}
#m = 5; maximum Log(Likelihood):     -96.36 {2,6,14,15,24}
#Final Log(Likelihood):              -97.14
#d^2: 0.00185004
#Level	T[Level]	N[Level]
...
#InputFile: stdin
#Polymorphic sites surveyed:         34
#Monomorphic sites surveyed:        966
#m = 1; maximum Log(Likelihood):     -37.47 {2}
#m = 2; maximum Log(Likelihood):     -34.89 {2,8}
#m = 3; maximum Log(Likelihood):     -33.73 {2,3,8}
#Final Log(Likelihood):              -34.89
#d^2: 2.11021
#Level	T[Level]	N[Level]
8	3.33e+05	7.60e+05
2	1.11e+06	2.25e+05
...
\ty{epos}. One from a population of water flea, \textit{Daphnia
...
#m = 1; maximum Log(Likelihood):    -973.30 {2}
#m = 2; maximum Log(Likelihood):    -307.00 {2,24}
#m = 3; maximum Log(Likelihood):    -304.11 {2,3,24}
#m = 4; maximum Log(Likelihood):    -297.26 {2,3,8,24}
#m = 5; maximum Log(Likelihood):    -297.16 {2,3,8,24,55}
#Final Log(Likelihood):             -297.26
#d^2: 0.0039003
#Level	T[Level]	N[Level]
...
...
#Final Log(Likelihood):          -90970456101.23
#d^2: 0.00546917
#Level  T[Level]        N[Level]
...
#Monomorphic sites surveyed:     185297
#m = 1; maximum Log(Likelihood): -181940912127.92 {2}
#m = 2; maximum Log(Likelihood): -181940911894.62 {2,39}
#m = 3; no improvement
#Final Log(Likelihood):          -181940911894.62
#d^2: 0.00634133
#Level	T[Level]	N[Level]
...
#Monomorphic sites surveyed: 2879559922
...
#Final Log(Likelihood):          -90970458924.22
#d^2: 8.04994e-05
#Level  T[Level]        N[Level]
...
#InputFile: stdin
#Polymorphic sites surveyed:       3417
#Monomorphic sites surveyed:    9996583
#m = 1; maximum Log(Likelihood):   -2122.57 {2}
#m = 2; maximum Log(Likelihood):   -1911.15 {2,6}
#m = 3; maximum Log(Likelihood):   -1821.29 {2,6,18}
#m = 4; no improvement
#Final Log(Likelihood):            -1821.29
#d^2: 2.26505
#Level	T[Level]	N[Level]
18	1.02e-01	1.00e+00
6	6.19e+03	1.10e+04
2	1.17e+04	1.73e+03
\end{verbatim}
...
\begin{verbatim}
#r  A[r]     V(A[r])      P[r]
1   2480.73  6.66727e+06  10586.3
2   2911.02  7.78837e+06  10488.3
3   3375.96  8.8827e+06   10374.3
...
29  11747.9  1.87453e+07  6631.56
\end{verbatim}
