...
SRCFILES= epos.c interface.c eprintf.c sfs.c tab.c popSizes.c util.c newton.c gsl_rng.c aaa.c
OBJFILES= epos.o interface.o eprintf.o sfs.o tab.o popSizes.o util.o newton.o gsl_rng.o aaa.o
